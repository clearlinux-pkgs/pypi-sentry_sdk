...
Version  : 1.9.8
Release  : 31
URL      : https://files.pythonhosted.org/packages/61/00/dd7e41da95c59f4ccf86be60fcbb5889dc7b215ca5e71c8108cb7892c0b8/sentry-sdk-1.9.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/61/00/dd7e41da95c59f4ccf86be60fcbb5889dc7b215ca5e71c8108cb7892c0b8/sentry-sdk-1.9.8.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.9.8
cd %{_builddir}/sentry-sdk-1.9.8
pushd ..
cp -a sentry-sdk-1.9.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662394601
