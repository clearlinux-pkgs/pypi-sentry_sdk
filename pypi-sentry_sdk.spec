...
Source0  : https://files.pythonhosted.org/packages/81/b6/662988ecd2345bf6c3a5c306a9a3590852742eff91d0a78a143398b816f3/sentry_sdk-2.22.0.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.22.0
cd %{_builddir}/sentry_sdk-2.22.0
pushd ..
cp -a sentry_sdk-2.22.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739810013
