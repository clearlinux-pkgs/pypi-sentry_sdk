...
Source0  : https://files.pythonhosted.org/packages/85/2f/a0f732270cc7c1834f5ec45539aec87c360d5483a8bd788217a9102ccfbd/sentry_sdk-2.25.1.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.25.1
cd %{_builddir}/sentry_sdk-2.25.1
pushd ..
cp -a sentry_sdk-2.25.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743613394
