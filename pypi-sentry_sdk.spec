...
Source0  : https://files.pythonhosted.org/packages/16/4e/1c357cdeafb72a45751f328e2bb88fbbede75997ee7f83bb1daba5f8ece1/sentry-sdk-1.13.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.13.0
cd %{_builddir}/sentry-sdk-1.13.0
pushd ..
cp -a sentry-sdk-1.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673626515
