...
Source0  : https://files.pythonhosted.org/packages/74/74/82f06055ccbcb05ba84b942346acf39f342fdf3937f2638cb780dac3f125/sentry-sdk-1.5.8.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.5.8
cd %{_builddir}/sentry-sdk-1.5.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647617113
...
cp %{_builddir}/sentry-sdk-1.5.8/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sentry_sdk/3e100b2f32e3b106d00353c68b24a2e3c70adf79
