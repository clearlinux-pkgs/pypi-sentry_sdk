...
Source0  : https://files.pythonhosted.org/packages/04/4c/af31e0201b48469786ddeb1bf6fd3dfa3a291cc613a0fe6a60163a7535f9/sentry_sdk-2.30.0.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.30.0
cd %{_builddir}/sentry_sdk-2.30.0
pushd ..
cp -a sentry_sdk-2.30.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749736459
