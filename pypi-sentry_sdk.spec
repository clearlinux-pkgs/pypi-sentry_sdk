...
Version  : 1.7.2
Release  : 19
URL      : https://files.pythonhosted.org/packages/0c/87/61ca3e2e047b34b5a6eca7de6a7f2344adf3568caadbe7f7aebcbf3b9bb8/sentry-sdk-1.7.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/0c/87/61ca3e2e047b34b5a6eca7de6a7f2344adf3568caadbe7f7aebcbf3b9bb8/sentry-sdk-1.7.2.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.7.2
cd %{_builddir}/sentry-sdk-1.7.2
pushd ..
cp -a sentry-sdk-1.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657895063
...
cp %{_builddir}/sentry-sdk-1.7.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sentry_sdk/3e100b2f32e3b106d00353c68b24a2e3c70adf79
