...
Source0  : https://files.pythonhosted.org/packages/32/03/496a7c8313658dec419303e8add969f314b7538c29f4ec5ebe6d86fb8ce2/sentry-sdk-1.12.1.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.12.1
cd %{_builddir}/sentry-sdk-1.12.1
pushd ..
cp -a sentry-sdk-1.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671477260
