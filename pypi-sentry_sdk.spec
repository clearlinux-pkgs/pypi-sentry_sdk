...
Source0  : https://files.pythonhosted.org/packages/10/59/eb90c45cb836cf8bec973bba10230ddad1c55e2b2e9ffa9d7d7368948358/sentry_sdk-2.32.0.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.32.0
cd %{_builddir}/sentry_sdk-2.32.0
pushd ..
cp -a sentry_sdk-2.32.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751035493
