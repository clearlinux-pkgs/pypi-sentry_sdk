...
Source0  : https://files.pythonhosted.org/packages/d0/45/c7ef7e12d8434fda8b61cdab432d8af64fb832480c93cdaf4bdcab7f5597/sentry_sdk-2.31.0.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.31.0
cd %{_builddir}/sentry_sdk-2.31.0
pushd ..
cp -a sentry_sdk-2.31.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750863406
