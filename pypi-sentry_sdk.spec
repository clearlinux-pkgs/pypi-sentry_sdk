...
Source0  : https://files.pythonhosted.org/packages/c9/9d/d61d64819ecb0481647229c3ee8ddc00887552acc23745fd65d0d4d066f3/sentry_sdk-2.8.0.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.8.0
cd %{_builddir}/sentry_sdk-2.8.0
pushd ..
cp -a sentry_sdk-2.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720475348
