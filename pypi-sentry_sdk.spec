...
Source0  : https://files.pythonhosted.org/packages/cf/b6/a92ae6fa6d7e6e536bc586776b1669b84fb724dfe21b8ff08297f2d7c969/sentry_sdk-2.27.0.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.27.0
cd %{_builddir}/sentry_sdk-2.27.0
pushd ..
cp -a sentry_sdk-2.27.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745503183
