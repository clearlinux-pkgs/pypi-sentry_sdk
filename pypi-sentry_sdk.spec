...
Version  : 1.9.2
Release  : 22
URL      : https://files.pythonhosted.org/packages/0b/c1/cd5097db94abe5fef064323e9463c9f8da0c1d42955ddd00c8abcf220f4f/sentry-sdk-1.9.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/0b/c1/cd5097db94abe5fef064323e9463c9f8da0c1d42955ddd00c8abcf220f4f/sentry-sdk-1.9.2.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.9.2
cd %{_builddir}/sentry-sdk-1.9.2
pushd ..
cp -a sentry-sdk-1.9.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659971856
