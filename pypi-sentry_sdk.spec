...
Source0  : https://files.pythonhosted.org/packages/69/e5/e5f71d62c629b5667c38824ad150a86d77ab010adafc9ef20f71ba939e82/sentry-sdk-1.25.1.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.25.1
cd %{_builddir}/sentry-sdk-1.25.1
pushd ..
cp -a sentry-sdk-1.25.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686176994
