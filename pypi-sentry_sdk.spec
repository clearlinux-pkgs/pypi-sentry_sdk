...
Source0  : https://files.pythonhosted.org/packages/68/e8/6a366c0cd5e129dda6ecb20ff097f70b18182c248d4c27e813c21f98992a/sentry_sdk-2.20.0.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.20.0
cd %{_builddir}/sentry_sdk-2.20.0
pushd ..
cp -a sentry_sdk-2.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736860770
