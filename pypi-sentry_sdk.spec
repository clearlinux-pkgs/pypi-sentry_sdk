...
Version  : 1.44.0
Release  : 91
URL      : https://files.pythonhosted.org/packages/19/60/7a663d541d31ad980f17ca3b958304c0267728bd5ac7cb2b95d4066a5ede/sentry-sdk-1.44.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/19/60/7a663d541d31ad980f17ca3b958304c0267728bd5ac7cb2b95d4066a5ede/sentry-sdk-1.44.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.44.0
cd %{_builddir}/sentry-sdk-1.44.0
pushd ..
cp -a sentry-sdk-1.44.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711728386
