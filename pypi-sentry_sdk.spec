...
Version  : 1.6.0
Release  : 16
URL      : https://files.pythonhosted.org/packages/a0/ff/bcbcea86a61228572fb04b678bbf656470d72363936288a9cfe0a92c9890/sentry-sdk-1.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/a0/ff/bcbcea86a61228572fb04b678bbf656470d72363936288a9cfe0a92c9890/sentry-sdk-1.6.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.6.0
cd %{_builddir}/sentry-sdk-1.6.0
pushd ..
cp -a sentry-sdk-1.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655910697
...
cp %{_builddir}/sentry-sdk-1.6.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sentry_sdk/3e100b2f32e3b106d00353c68b24a2e3c70adf79
