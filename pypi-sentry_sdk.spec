...
Source0  : https://files.pythonhosted.org/packages/12/ae/ebd3d574dfcaabf43cf26c95c8561751f3d0688f40da7ddb85b6c66ad17e/sentry-sdk-1.40.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.40.0
cd %{_builddir}/sentry-sdk-1.40.0
pushd ..
cp -a sentry-sdk-1.40.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706632645
