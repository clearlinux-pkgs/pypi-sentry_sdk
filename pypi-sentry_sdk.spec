...
Source0  : https://files.pythonhosted.org/packages/5e/bb/6a41b2e0e9121bed4d2ec68d50568ab95c49f4744156a9bbb789c866c66d/sentry_sdk-2.28.0.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.28.0
cd %{_builddir}/sentry_sdk-2.28.0
pushd ..
cp -a sentry_sdk-2.28.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747060431
