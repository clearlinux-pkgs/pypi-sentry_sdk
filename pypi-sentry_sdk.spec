...
Source0  : https://files.pythonhosted.org/packages/f5/fb/333871fe6ada76a7b03d2e900330866e97df89bc13c186bfb5bb48af1145/sentry-sdk-1.32.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.32.0
cd %{_builddir}/sentry-sdk-1.32.0
pushd ..
cp -a sentry-sdk-1.32.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697037237
