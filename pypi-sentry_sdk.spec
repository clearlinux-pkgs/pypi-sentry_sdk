...
Version  : 1.7.0
Release  : 17
URL      : https://files.pythonhosted.org/packages/26/65/d77f2a67ef0ba046c7d78d0ca25042682cd4a640ce28bb3520812a21d9d0/sentry-sdk-1.7.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/26/65/d77f2a67ef0ba046c7d78d0ca25042682cd4a640ce28bb3520812a21d9d0/sentry-sdk-1.7.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.7.0
cd %{_builddir}/sentry-sdk-1.7.0
pushd ..
cp -a sentry-sdk-1.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657555665
...
cp %{_builddir}/sentry-sdk-1.7.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sentry_sdk/3e100b2f32e3b106d00353c68b24a2e3c70adf79
