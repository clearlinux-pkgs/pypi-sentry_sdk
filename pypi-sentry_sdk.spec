...
Version  : 1.9.0
Release  : 21
URL      : https://files.pythonhosted.org/packages/4c/24/dc6b31bcdf6fcabe92982078e56396225f561285584eaf3159af5477f6c9/sentry-sdk-1.9.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/4c/24/dc6b31bcdf6fcabe92982078e56396225f561285584eaf3159af5477f6c9/sentry-sdk-1.9.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.9.0
cd %{_builddir}/sentry-sdk-1.9.0
pushd ..
cp -a sentry-sdk-1.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659021012
