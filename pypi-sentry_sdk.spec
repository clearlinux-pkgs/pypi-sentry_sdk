...
Source0  : https://files.pythonhosted.org/packages/c0/f7/5e860b7dc763a00a484cc862e3b8ddcc62656ec680cec375e92a6fef197b/sentry-sdk-1.42.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.42.0
cd %{_builddir}/sentry-sdk-1.42.0
pushd ..
cp -a sentry-sdk-1.42.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710542009
