...
Version  : 1.11.0
Release  : 38
URL      : https://files.pythonhosted.org/packages/51/0d/15c10d58042cd46c19a143d8877d7bc4abe23dd6418b78955d2be2865243/sentry-sdk-1.11.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/51/0d/15c10d58042cd46c19a143d8877d7bc4abe23dd6418b78955d2be2865243/sentry-sdk-1.11.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.11.0
cd %{_builddir}/sentry-sdk-1.11.0
pushd ..
cp -a sentry-sdk-1.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668449171
