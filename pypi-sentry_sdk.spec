...
Source0  : https://files.pythonhosted.org/packages/2e/39/eb97e463e372b38d0b9c7ae705822d1df717940c04cb6d998ae15bf3eb02/sentry_sdk-2.12.0.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.12.0
cd %{_builddir}/sentry_sdk-2.12.0
pushd ..
cp -a sentry_sdk-2.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722444300
