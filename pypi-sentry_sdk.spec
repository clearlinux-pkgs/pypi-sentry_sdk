...
Version  : 1.9.6
Release  : 29
URL      : https://files.pythonhosted.org/packages/c4/d1/1649fbbf654d9caeef95bfe2578509e2ca9d2921d7ed3d0b2701e071b1d5/sentry-sdk-1.9.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/c4/d1/1649fbbf654d9caeef95bfe2578509e2ca9d2921d7ed3d0b2701e071b1d5/sentry-sdk-1.9.6.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.9.6
cd %{_builddir}/sentry-sdk-1.9.6
pushd ..
cp -a sentry-sdk-1.9.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661968300
