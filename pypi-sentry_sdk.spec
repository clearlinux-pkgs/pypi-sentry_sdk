...
Source0  : https://files.pythonhosted.org/packages/af/68/43d91ec36f09daf0cc0dd2dae9414f24f423ed56be6df2a9e5f317af26ee/sentry-sdk-1.5.10.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.5.10
cd %{_builddir}/sentry-sdk-1.5.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650038343
...
cp %{_builddir}/sentry-sdk-1.5.10/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sentry_sdk/3e100b2f32e3b106d00353c68b24a2e3c70adf79
