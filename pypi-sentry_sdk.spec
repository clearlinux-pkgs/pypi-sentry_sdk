...
Version  : 2.6.0
Release  : 103
URL      : https://files.pythonhosted.org/packages/cb/b0/378c322a1d17066c11d41cf58138e0867957db752c238462a21cc3a32a40/sentry_sdk-2.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/cb/b0/378c322a1d17066c11d41cf58138e0867957db752c238462a21cc3a32a40/sentry_sdk-2.6.0.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.6.0
cd %{_builddir}/sentry_sdk-2.6.0
pushd ..
cp -a sentry_sdk-2.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718921060
