...
Source0  : https://files.pythonhosted.org/packages/b5/bf/680dccdef2576e85b3773de1acde3d263d2c3f105187562a6653cc550a8b/sentry-sdk-1.9.9.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.9.9
cd %{_builddir}/sentry-sdk-1.9.9
pushd ..
cp -a sentry-sdk-1.9.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664206593
