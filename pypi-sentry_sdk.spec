...
Source0  : https://files.pythonhosted.org/packages/22/67/d552a5f8e5a6a56b2feea6529e2d8ccd54349084c84176d5a1f7295044bc/sentry_sdk-2.29.1.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.29.1
cd %{_builddir}/sentry_sdk-2.29.1
pushd ..
cp -a sentry_sdk-2.29.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747674492
