...
Source0  : https://files.pythonhosted.org/packages/36/9e/036578fdb2944fc96a89bbcde23e9411379da6d1690a8b9f62a77a2a7fb6/sentry-sdk-1.15.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.15.0
cd %{_builddir}/sentry-sdk-1.15.0
pushd ..
cp -a sentry-sdk-1.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675785706
