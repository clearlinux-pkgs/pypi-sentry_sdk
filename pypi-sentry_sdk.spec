...
Source0  : https://files.pythonhosted.org/packages/46/13/794d29a720ca96c01fca8ff97e5dfa76982a7ba99d1391515e981375b878/sentry-sdk-1.41.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.41.0
cd %{_builddir}/sentry-sdk-1.41.0
pushd ..
cp -a sentry-sdk-1.41.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709827610
