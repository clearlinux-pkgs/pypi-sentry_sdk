...
Source0  : https://files.pythonhosted.org/packages/d3/64/a5e0b77e834bec753927853accef256f86e0c2695ed5d16a2048fe790679/sentry-sdk-1.14.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.14.0
cd %{_builddir}/sentry-sdk-1.14.0
pushd ..
cp -a sentry-sdk-1.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674495692
