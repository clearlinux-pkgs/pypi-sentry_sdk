...
Version  : 1.7.1
Release  : 18
URL      : https://files.pythonhosted.org/packages/08/b2/2b5530d79a3fc73cef40c47506da92b65d9fe3983c93328028387bf4e620/sentry-sdk-1.7.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/08/b2/2b5530d79a3fc73cef40c47506da92b65d9fe3983c93328028387bf4e620/sentry-sdk-1.7.1.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.7.1
cd %{_builddir}/sentry-sdk-1.7.1
pushd ..
cp -a sentry-sdk-1.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657727561
...
cp %{_builddir}/sentry-sdk-1.7.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sentry_sdk/3e100b2f32e3b106d00353c68b24a2e3c70adf79
