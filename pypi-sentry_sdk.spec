...
Source0  : https://files.pythonhosted.org/packages/6d/b3/39e4cd04b75a1ada788342d0d30a781cf65b5e43da806d5bf2bad4846ea3/sentry_sdk-2.11.0.tar.gz
...
%prep
%setup -q -n sentry_sdk-2.11.0
cd %{_builddir}/sentry_sdk-2.11.0
pushd ..
cp -a sentry_sdk-2.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721836043
