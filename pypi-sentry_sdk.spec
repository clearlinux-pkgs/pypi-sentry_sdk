...
Version  : 1.8.0
Release  : 20
URL      : https://files.pythonhosted.org/packages/cc/1c/2a9852063e2edcada958c544d3d84d0826f6f0f618f84ef3cfc58584f42a/sentry-sdk-1.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/cc/1c/2a9852063e2edcada958c544d3d84d0826f6f0f618f84ef3cfc58584f42a/sentry-sdk-1.8.0.tar.gz
...
%prep
%setup -q -n sentry-sdk-1.8.0
cd %{_builddir}/sentry-sdk-1.8.0
pushd ..
cp -a sentry-sdk-1.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658415466
...
cp %{_builddir}/sentry-sdk-1.8.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sentry_sdk/3e100b2f32e3b106d00353c68b24a2e3c70adf79
